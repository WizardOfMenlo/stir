...
class IOPNonOracleMessage:
    def __init__(self, ferrari_iop, field_elements, oracle_name: str) -> None:
        self.oracle_name = oracle_name
        self.field_elements = field_elements
        self.message_size = field_elements * ferrari_iop.field_size_bits
...
class IOPOracleMessage:
    def __init__(self, ferrari_iop, proof_length, alphabet_size, folding, oracle_name: str) -> None:
        self.ferrari_iop = ferrari_iop
    ...
    def compile(self) -> ArgRound:
        commitment_size = self.ferrari_iop.rom.secparam
        authentication_path_size = self.ferrari_iop.rom.authentication_path_size(self.proof_length//self.folding,self.verifier_queries) + self.verifier_queries * min(self.alphabet_size * self.folding, self.ferrari_iop.rom.secparam) # Note this the term in the min is the opening of the leaf close to our
